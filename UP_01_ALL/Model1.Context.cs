...
namespace UP_01_ALL
{
    ...
    public partial class labPermEntities : DbContext
    {
        public labPermEntities()
            : base("name=labPermEntities")
        {
        }
        ...
        public virtual DbSet<AttemptStatus> AttemptStatus { get; set; }
        ...
        public virtual DbSet<RenderingOfServisec> RenderingOfServisec { get; set; }
